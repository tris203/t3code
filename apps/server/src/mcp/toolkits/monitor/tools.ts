...
import { MonitorUnavailableError } from "../../MonitorSession.ts";
...
const monitoringEnabled = () => {
  ...
  return (
    fiber !== undefined &&
    (Context.getOrUndefined(fiber.context, McpInvocationContext)?.capabilities.has("monitor") ??
      false)
  );
};
...
export const MonitorSubscribeTool = Tool.make("monitor_subscribe", {
  ...
  parameters,
  success,
  failure: MonitorUnavailableError,
